...
Live Demo: https://flotiqgatsbyevent2.gatsbyjs.io
...
1. **Start the project from template using [Flotiq CLI]((https://github.com/flotiq/flotiq-cli))**
   ...
   flotiq start [projectName] https://github.com/flotiq/flotiq-gatsby-event-2.git [flotiqApiKey]
    ```
...
2. **You can also start the project from template using Gatsby CLI**
    ...
    ```bash
    gatsby new flotiq-gatsby-event-2 https://github.com/flotiq/flotiq-gatsby-event-2.git
    ```
...
4. **Start developing.**
   ...
   It will add five examples object to your Flotiq account.
...
5. **Open the source code and start editing!**
   ...
   Open the `flotiq-gatsby-event-2` directory in your code editor of choice and edit `src/templates/index.js`. Save your changes and the browser will update in real time!
...
[<img src="https://www.gatsbyjs.com/deploynow.svg" alt="Deploy to Gatsby Cloud">](https://www.gatsbyjs.com/dashboard/deploynow?url=https://github.com/flotiq/flotiq-gatsby-event-2)

You can also deploy this project to [Heroku](https://www.heroku.com/) in 3 minutes:

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/flotiq/flotiq-gatsby-event-2)

Or to [Netlify](https://www.netlify.com/):

[![Deploy](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/flotiq/flotiq-gatsby-event-2)
...
If you found a bug, please report it in [issues](https://github.com/flotiq/flotiq-gatsby-event-2/issues).
