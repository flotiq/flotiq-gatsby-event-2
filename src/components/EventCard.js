...
const PastEventLabel = ({ date }) => (
    <div
        className="flex !basis-1/6 md:!basis-1/12 flex-col justify-center items-center
            basis-1/12 border-solid border border-gray font-light relative"
    >
        <p
            className="absolute top-0 left-0 w-full px-1 md:px-3
...
const FeaturedEventLabel = ({ date }) => (
    <div
        className="flex !basis-1/6 lg:!basis-1/12 flex-col justify-center items-center
            basis-1/12 border-solid border-2 border-primary font-light relative"
    >
        <p
            className="absolute top-0 left-0 w-full px-1 md:px-3 py-3 text-xs md:text-base
